...
<svelte:head>
	<title>WHOOP Authentication - Technically Fit</title>
</svelte:head>
	...
	<div class="max-w-md w-full space-y-8">
		<div class="text-center">
			...
			>
				{#if processing}
					<div
						class="animate-spin w-8 h-8 border-4 border-yellow-600 border-t-transparent rounded-full"
					></div>
				{:else if isError}
		...
		{#if processing}
			<div class="text-center">
				<p class="text-gray-600 text-sm">Please wait while we set up your WHOOP integration...</p>
			</div>
		{:else if !isError}
				...
				<div class="flex">
					...
					<div>
						...
						<p class="text-sm text-green-700 mt-1">
							Your WHOOP device is now connected. We'll start syncing your strain, recovery, and
							sleep data.
						</p>
					</div>
				</div>
