...
<svelte:head>
  <title>GitFit Marketplace - Training Programs & Personal Trainers</title>
  <meta name="description" content="Discover training programs and connect with certified personal trainers. Browse hundreds of fitness programs or book custom coaching services." />
</svelte:head>
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
  ...
  <div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="flex justify-center mb-8">
      <div class="bg-white dark:bg-slate-800 rounded-lg p-1 shadow-sm border border-slate-200 dark:border-slate-700">
        <button
          class="px-6 py-2 rounded-md font-medium transition-all duration-200 {activeTab === 'programs' 
        ...
        <button
          class="px-6 py-2 rounded-md font-medium transition-all duration-200 {activeTab === 'trainers' 
            ? 'bg-blue-600 text-white shadow-sm' 
            : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white'}"
