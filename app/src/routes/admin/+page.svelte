...
<svelte:head>
        <title>Admin - Exercise Import - GitFit</title>
</svelte:head>

<div class="space-y-6">
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Exercise Database Administration</h1>
                <p class="text-gray-600">Import exercises from Free Exercise Database and manage equipment recommendations</p>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <div class="space-y-4">
                        ...
                        {#if importResult}
                                <div class="rounded-lg p-4 {importResult.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}">
