...
<svelte:head>
        <title>Fitness Data - GitFit</title>
</svelte:head>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                        ...
                                        <p class="text-2xl font-semibold text-blue-600">{fitnessOverview.todaySteps.toLocaleString()}</p>
                                        <p class="text-xs text-gray-500">Weekly avg: {fitnessOverview.weeklyAvgSteps.toLocaleString()}</p>
                                </div>
                        </div>
                </div>
