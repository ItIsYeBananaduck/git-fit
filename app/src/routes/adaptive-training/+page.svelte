	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		<div class="mb-8">
			...
			<p class="text-lg text-gray-600">
				AI-powered workout adjustments based on your fitness tracker data, recovery metrics, and
				adaptation patterns
			</p>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
			<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
				...
				<p class="text-gray-600">
					Analyzes your recovery, strain, and HRV data from connected trackers to determine optimal
					training intensity
				</p>
			</div>
			...
			<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
				...
				<p class="text-gray-600">
					Learns your adaptation patterns over time to optimize long-term progression and prevent
					plateaus
				</p>
			</div>
		</div>
				...
				<div class="flex">
					...
					<div>
						<h3 class="text-sm font-medium text-yellow-800">
							Connect Fitness Trackers for Personalized Training
						</h3>
						<p class="text-sm text-yellow-700 mt-1">
							Connect your fitness tracker (WHOOP, Oura Ring, etc.) to enable AI-powered workout
							adjustments based on your recovery data.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="mb-6">
			...
			<div class="flex space-x-2">
				{#each exercises as exercise}
					<button
						class="px-4 py-2 rounded-lg font-medium transition-colors {selectedExercise ===
						exercise.name
		...
		<div class="mb-8">
			...
			<div class="mb-8">
				...
				<p class="text-sm text-gray-600 mb-6">
					These platforms require mobile apps for data access. We're exploring integration options
					for future releases.
				</p>
				<div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
		...
		{#if showSettings}
			<div class="mb-8">
				<SafetySettings settings={safetySettings} onSettingsChange={handleSafetySettingsChange} />
			</div>
		{/if}
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
			...
			<div>
				...
				<AdaptiveWorkoutCard exercise={selectedExerciseData} {connectedTrackers} {safetySettings} />
			</div>
