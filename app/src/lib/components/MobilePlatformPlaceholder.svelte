    ...
    {#if !comingSoon}
      <div class="integration-note">
        ...
        <div class="note-content">
          ...
          <p>This platform requires a companion mobile app for data access. Web-only integration is not currently available.</p>
        </div>
      </div>
    {/if}
    ...
    <div class="action-section">
      {#if comingSoon}
        <div class="roadmap-info">
          <p>We're working on bringing this integration to GitFit. Stay tuned for updates!</p>
        </div>
      {:else}
        <div class="app-links">
