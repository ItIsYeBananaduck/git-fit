...
importers:
  ...
  .:
    dependencies:
      ...
      lucide-svelte:
        specifier: ^0.542.0
        version: 0.542.0(svelte@5.38.10)
      stripe:
        specifier: ^18.5.0
...
packages:
  ...
  cordova-plugin-music-controls2@3.0.7:
    resolution: {integrity: sha512-XnbMwcVv1lZSdV78DQqxTJ22/290G+Ks0kn36NJrLT6GF6+5L11L3pf2Hey+e8LoqObPcXy4uTANc+ToADanlg==}
    engines: {'0': {name: cordova, version: '>=6.0.0'}}
...
snapshots:
  ...
  lucide-svelte@0.542.0(svelte@5.38.10):
    dependencies:
      svelte: 5.38.10
